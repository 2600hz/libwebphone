...
(function () {
	...
	kazoo.register = function(params) {
		...
		if(kazoo.version === 'rtmp') {
			...
			kazoo.sips.attachMediaStream = function() {
				var element = kazoo.videoRemote,
					stream = kazoo.sipjs.session.mediaHandler.getRemoteStreams()[0];
